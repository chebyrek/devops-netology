...
![Task 3](/homework/img/100303.jpg)
## Задание 4
...
```json
{
  ...
  "panels": [
    {
      "alert": {
        ...
        "frequency": "1m",
        "handler": 1,
        "message": "CPU LA is above 0.8",
        "name": "CPU LA for 1/5/15 min alert",
        "noDataState": "no_data",
        "notifications": [
          {
            "uid": "sprIVpKnk"
    ...
    },
    {
      ...
      "targets": [
        {
          "expr": "sum (node_filesystem_free_bytes/(1024*1024*1024))",
          "interval": "",
  ...
  "time": {
    "from": "2021-10-29T02:51:16.194Z",
    "to": "2021-10-30T00:27:58.136Z"
  },
  "timepicker": {},
  "timezone": "",
  "title": "netology",
